...
session_start();
ob_start();
if(isset($_SESSION['oturum'])&&$_SESSION['id'])
{
?>
<!DOCTYPE html>
<html>
...
<div class="w3-top">
 <div class="w3-bar w3-theme-d2 w3-left-align w3-large">
  ...
  <a href="home2.html" class="w3-bar-item w3-button w3-padding-large w3-theme-d4"><b>UM</b> FreedomTeam</a>
    ...
    <div class="w3-col m3">
      ...
      <div class="w3-card w3-round w3-white">
        <div class="w3-container">
         ...
         <p class="w3-center"><img src="photo1.jpg" class="w3-circle" style="height:106px;width:106px" alt="Avatar"></p>
         <hr>
         <p><i class="fa fa-pencil fa-fw w3-margin-right w3-text-theme"></i> Slacker, UI</p>
         <p><i class="fa fa-home fa-fw w3-margin-right w3-text-theme"></i> Ankara, TR</p>
         <p><i class="fa fa-birthday-cake fa-fw w3-margin-right w3-text-theme"></i> February 16, 1996</p>
        </div>
      </div>
      <br>
...
<footer class="w3-container w3-theme-d5">
  <p>Powered by <a href="https://www.ksfreedom.com" target="_blank">ksfreedom.com</a></p>
</footer>
